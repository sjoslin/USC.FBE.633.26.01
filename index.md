...
See [Motivation](motivation) for the need for proper guardrails.
...
Together this represents a powerful nearly automated pipeline to do sophisticated empirical analysis of financial data.
